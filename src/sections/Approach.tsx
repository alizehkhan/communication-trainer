const Approach = () => {
  return (
    <div className="bg-gray-800 text-white py-24">
      <h2 className="font-serif text-5xl container mx-auto text-center font-bold leading-tight text-gray-200">
        My approach uses a blend of
      </h2>
      <div className="flex justify-center mt-20 container mx-auto flex-wrap gap-24">
      ...
      <div className="flex justify-center mt-16 container mx-auto flex-wrap gap-24">
        <div className="w-[280px] text-center">
