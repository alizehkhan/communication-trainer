...
const About = forwardRef((_, ref: Ref<HTMLDivElement>) => (
  <div className="container mx-auto py-20" id="about" ref={ref}>
    ...
    <p className="text-xl max-w-2xl text-gray-600 mt-8">
      ...
      transforms this into a clearer & softer culture that brings more
      motivation and humanness into the workplace.
    </p>
    <p className="text-xl max-w-2xl text-gray-600 mt-8">
      ...
      and deliver this cleanly, rather than passive aggressively!
    </p>
