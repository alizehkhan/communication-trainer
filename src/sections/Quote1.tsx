const Quote1 = ({ refs }: { refs: any }) => {
  return (
    <div className="bg-gray-100 py-16 text-center">
      ...
      <a
        className="mt-6 inline-block rounded-md bg-amber-700 px-6 py-3 font-bold text-white outline-offset-0 hover:bg-amber-800 focus:outline focus:outline-4 focus:outline-orange-300"
        href="#contact"
        onClick={(event) => {
